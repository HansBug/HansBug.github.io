...
| 分类 | 团体 | 成员 | 当前桌宠池 |
| --- | --- | --- | --- |
| 主线 | Poppin'Party | 戸山 香澄 / 花園 たえ / 牛込 りみ / 山吹 沙綾 / 市ヶ谷 有咲 | `5/5` 已覆盖 |
| 主线 | Afterglow | 美竹 蘭 / 青葉 モカ / 上原 ひまり / 宇田川 巴 / 羽沢 つぐみ | `5/5` 已覆盖 |
...
| 分类 | 团体 | 公开成员 | 当前桌宠池 | 备注 |
| --- | --- | --- | --- | --- |
| 剧情侧团 | Glitter*Green | 牛込 ゆり / 二十騎 ひなこ / 鵜沢 リィ / 鰐部 七菜 | `0/4` 全缺 | 第一季老团 |
| 剧情侧团 | CHiSPA | 海野 夏希 / 大湖 里実 / 森 文華 / 川端 真結 | `0/4` 全缺 | 沙绫旧团 |
| 偶像组合 | sumimi | 三角 初華 / 純田 まな | `0/2` 以该组合形态全缺 | 初華本人已在 Ave Mujica 行出现 |
| 剧情侧团 | CRYCHIC | 高松 燈 / 長崎 そよ / 椎名 立希 / 若葉 睦 / 豊川 祥子 | `0/5` 以该团形态全缺 | 5 名成员已在 MyGO!!!!! / Ave Mujica 行出现 |
| 偶像侧团 | ViVidCanvas | Serizawa Mio / Koganei Shino / Yamase Serina | `0/3` 全缺 | Pastel*Palettes 的后辈 / 妹团 |
| 偶像侧团 | Marmalade | Ayumi / Nao Kosaki / Miharu | `0/3` 全缺 | 公开可访问资料较少 |
| 剧情侧团 | DEATH GALAXY | Uzaki Sora / Ohta You / Galaxy owner | `0/3` 全缺 | 佐藤ますき相关旧团 |
| 剧情侧团 | Mitt Clang | Kana（公开可确认） | `0/1+` | 当前可访问公开资料里只能稳定确认鼓手 Kana |
| 原型 / 早期资料 | RAZES | Sakagami / Utsunomiya / Kanda / unnamed drummer | `0/3+1` | 更接近早期 / 原型设定，不建议与现行资源池同口径统计 |
...
- 角色 / 侧团补充公开资料：
  - <https://en.wikipedia.org/wiki/List_of_BanG_Dream!_characters>
  - <https://bandori.fandom.com/wiki/ViVidCanvas>
  - 其余少数资料稀缺团体使用公开搜索结果与对应条目摘要交叉核对，已在表中单独标出“资料较少 / 原型设定 / 部分公开确认”。
